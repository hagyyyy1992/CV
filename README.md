...
- [これまでの経験](#%E3%81%93%E3%82%8C%E3%81%BE%E3%81%A7%E3%81%AE%E7%B5%8C%E9%A8%93)
...
## 条件面
直近1〜2年は5,000〜6,500円/時、100万円/月〜での稼働実績があります。<br>
...
- 業務内容
  - 介護医療領域に特化した求人サービスの開発支援
    ...
    - Python、FastAPI、sqlalchemy、pydanticでのバッチ処理の実装
    - 技術スタック
      - Python、FastAPI、TypeScript、NestJS
  - 介護医療事業所向けの請求管理サービスの開発支援
    - バックエンド処理の改修
    - 新規APIの実装と実装したAPIとフロントの繋ぎ込み、UI実装
    - 技術スタック
