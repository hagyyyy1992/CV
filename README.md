...
## 概要
2017年からエンジニアをしています。
Webサービスを実装するエンジニアとしてフロント・バック・インフラ・ウェブ・アプリを幅広く経験してきました。
正社員の時はPMの立ち回りや採用などもやってました。
2021年からフリーランスとして独立して立ち上げ間もないスタートアップ、上場を目指しているのベンチャー、新規プロジェクト立ち上げ中の上場企業様など幅広く開発支援を続けています。
バックエンドでの開発支援が即戦力になりやすいです。
...
## 貢献しやすいこと
特に即戦力として貢献しやすいです。
- PHP/Pythonでのバックエンド開発
- Javascript/Typescriptでのフロントエンド/バックエンド開発

## 貢献しにくいこと
全く経験がないわけではないですがキャッチアップが必要です。
