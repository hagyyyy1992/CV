...
- [現在関心あること](#%E7%8F%BE%E5%9C%A8%E9%96%A2%E5%BF%83%E3%81%82%E3%82%8B%E3%81%93%E3%81%A8)
...
- その他
    - Git, Github, Circle CI, PHPUnit, Scss, BEM, Gulp, webpack, npm, package.json, SPA, Atomic Design, Storybook, Vue
      Router, Vuex, Redux, ESLint, Apache, Nginx, Docker, docker-compose, Vagrant, Makefile, Sider, pay.jp, Firebase,
      Realtime Database
...
- 企画、技術選定、開発フロー構築、組織作りからの0→1
- 経営メンバーとしてCTOの役割を実行する
- 自分で法人設立して事業、組織、会社を作る
...
- 新規プロダクト開発
  - プロダクトの企画段階から参画。要件をヒアリングしながら仕様の取りまとめと詳細設計を行う。
    ...
    上記作業完了後はサーバーサイドの設計と開発に従事。 2019年1月に無事ローンチすることができた。
